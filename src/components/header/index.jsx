      ...
      {modalSearch && (
        ...
        >
          <div
            ...
            className="p-4 px-6 bg-[#ffffff0a] backdrop-blur-[5px] rounded-[12px] border border-[#ffffff38] flex items-center gap-4"
          >
            ...
            <input
              ...
              name="search"
            />
            <div className="bg-[#303030] rounded-[12px] p-[2px] cursor-pointer hover:bg-[#383838]">
